...
export default function Chooseus() {
    return (
        ...
        <section className="why_choose_us home_four" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="500">
                ...
                <div className="row">
                    <div className="col-xl-4 col-md-6 col-sm-12">
                        <div className="why_choose_block_two mb_40" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="550">
                            ...
                            <div className="link_btn"><a href="#">Discover More <i className="fa-solid fa-angle-right"></i></a></div>
                        </div>
                    </div>
                    <div className="col-xl-4 col-md-6 col-sm-12">
                        <div className="why_choose_block_two mb_40 hover" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="600">
                            <div className="choose_icon">
                    ...
                    <div className="col-xl-4 col-md-6 col-sm-12">
                        <div className="why_choose_block_two mb_40" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="650">
                            <div className="choose_icon">
