...
export default function VideoPopup({ style, text }) {
    ...
    return (
        <>
            ...
            {!style &&
                <a onClick={() => setOpen(true)} className="overlay-link lightbox-image video-fancybox ripple"><i className="icon-38" /></a>
            }
            ...
            {style === 2 &&
                <div className="video-btn">
                    <a onClick={() => setOpen(true)} className="overlay-link lightbox-image video-fancybox ripple"><i className="icon-38" /></a><h6>{text ? text : "Latest Program Video"}</h6>
                </div>
            }
