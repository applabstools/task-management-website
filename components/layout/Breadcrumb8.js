...
export default function Breadcrumb({ breadcrumbTitle8 }) {
    return (
        <>
        ...
        <section className="page_breadcrumb">
            ...
            <div className="container">
                <div className="breadcrumb_content centred">
                    <div className="breadcrumb_sutitle"><h6>Product Details</h6></div>
                    <h1 className="breadcrumb_title">{breadcrumbTitle8}</h1>
