...
export default function Breadcrumb({ breadcrumbTitle10 }) {
    return (
        <>
        ...
        <section className="page_breadcrumb">
            ...
            <div className="container">
                <div className="breadcrumb_content centred">
                    <div className="breadcrumb_sutitle"><h6>Checkout</h6></div>
                    <h1 className="breadcrumb_title">{breadcrumbTitle10}</h1>
